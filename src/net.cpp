...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "mtgoxcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seedhere.com", "seedhere.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"seedhere.com", "testseedhere.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. mtgoxcoin is probably already running."), addrBind.ToString().c_str());
        else
